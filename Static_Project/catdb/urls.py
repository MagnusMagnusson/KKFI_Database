...
urlpatterns = [
    ...
    url(r'^ems/register/?$', views.view_addEms, name='addEms'),
    ...
    url(r'^shows/files/nominations?$', views.file_ShowNominations, name='view_ShowNominations'),   
	url(r'^shows/files/judgeSheets?$', views.file_JudgeSheets, name='view_ShowJudgeSheets'),
	...
	url(r'^api/ems/register', views.api_ems_register, name='api_ems_register'),
